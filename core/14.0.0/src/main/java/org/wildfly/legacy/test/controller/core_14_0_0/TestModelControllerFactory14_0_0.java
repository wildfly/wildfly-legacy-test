 ...
 * @author Tomaz Cerar
 */
public class TestModelControllerFactory14_0_0 implements TestModelControllerFactory {
    ...
    public InjectedValue<ContentRepository> getContentRepositoryInjector(ModelTestModelControllerService service) {
        return ((TestModelControllerService14_0_0)service).getContentRepositoryInjector();
    }
}
