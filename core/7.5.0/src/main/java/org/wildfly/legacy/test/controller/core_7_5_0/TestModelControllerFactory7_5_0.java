...
public class TestModelControllerFactory7_5_0 implements TestModelControllerFactory {
    ...
    public ModelTestModelControllerService create(ProcessType processType, RunningModeControl runningModeControl,
        ...
        return new TestModelControllerService7_5_0(processType, runningModeControl, persister, validateOpsFilter, type,
                modelInitializer, new TestModelControllerService7_5_0.DelegatingResourceDefinition(type), processState, extensionRegistry);
    }

    @Override
    public InjectedValue<ContentRepository> getContentRepositoryInjector(ModelTestModelControllerService service) {
        return ((TestModelControllerService7_5_0)service).getContentRepositoryInjector();
    }
}
