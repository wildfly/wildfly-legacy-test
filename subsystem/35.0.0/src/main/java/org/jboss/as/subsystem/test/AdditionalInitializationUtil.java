...
import org.wildfly.legacy.test.controller.subsystem_35_0_0.TestModelControllerService35_0_0;
...
public class AdditionalInitializationUtil {
    ...
    public static void doExtraInitialization(AdditionalInitialization additionalInit, ControllerInitializer controllerInitializer, ExtensionRegistry extensionRegistry, ManagementModel managementModel, TestModelControllerService35_0_0 controller) {
        controllerInitializer.setTestModelControllerAccessor(new TestControllerAccessor35_0_0(controller));
    ...
    private static class TestControllerAccessor35_0_0 implements TestControllerAccessor {
        private final TestModelControllerService35_0_0 delegate;

        public TestControllerAccessor35_0_0(TestModelControllerService35_0_0 delegate) {
