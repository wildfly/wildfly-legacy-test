...
import org.wildfly.legacy.test.controller.subsystem_25_0_0.TestModelControllerService25_0_0;
...
public class AdditionalInitializationUtil {
    ...
    public static void doExtraInitialization(AdditionalInitialization additionalInit, ControllerInitializer controllerInitializer, ExtensionRegistry extensionRegistry, ManagementModel managementModel, TestModelControllerService25_0_0 controller) {
    ...
    private static class TestControllerAccessor23_0_0 implements TestControllerAccessor {
        private final TestModelControllerService25_0_0 delegate;

        public TestControllerAccessor23_0_0(TestModelControllerService25_0_0 delegate) {
