...
public class TestModelControllerService18_0_0 extends ModelTestModelControllerService {
    ...
    TestModelControllerService18_0_0(final ProcessType processType, final Extension mainExtension, final ControllerInitializer controllerInitializer,
        ...
        super(processType, runningModeControl, extensionRegistry.getTransformerRegistry(), persister, validateOpsFilter,
                ...
                new ControlledProcessState(true), capabilityRegistry, Controller18x.INSTANCE);
