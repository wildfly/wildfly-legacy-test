 ...
 */
package org.wildfly.legacy.test.controller.subsystem_7_1_2;
...
public class TestModelControllerFactory7_1_2 implements TestModelControllerFactory {
    public ModelTestModelControllerService create(Extension mainExtension, ControllerInitializer controllerInitializer,
        ...
        return new TestModelControllerService7_1_2(mainExtension, controllerInitializer, additionalInit, new RunningModeControl(AdditionalInitializationUtil.getRunningMode(additionalInit)), extensionRegistry, persister, validateOpsFilter, registerTransformers);
    }
}