...
import org.wildfly.legacy.test.controller.subsystem_31_0_0.TestModelControllerService31_0_0;
...
public class AdditionalInitializationUtil {
    ...
    public static void doExtraInitialization(AdditionalInitialization additionalInit, ControllerInitializer controllerInitializer, ExtensionRegistry extensionRegistry, ManagementModel managementModel, TestModelControllerService31_0_0 controller) {
        controllerInitializer.setTestModelControllerAccessor(new TestControllerAccessor31_0_0(controller));
    ...
    private static class TestControllerAccessor31_0_0 implements TestControllerAccessor {
        private final TestModelControllerService31_0_0 delegate;

        public TestControllerAccessor31_0_0(TestModelControllerService31_0_0 delegate) {
